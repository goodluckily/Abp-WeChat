...
namespace WeChat.EntityFramewoekCore.Migrations
{
    ...
    [Migration("20220115091820_initcsdn")]
    partial class initcsdn
    {
            ...
            modelBuilder.Entity("WeChat.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a016f34-a23c-37fb-4e07-f845581274a4"),
                            CreateTime = new DateTime(2022, 1, 15, 17, 18, 18, 684, DateTimeKind.Local).AddTicks(8532),
                            CreateUserId = new Guid("3a016f34-a23b-1664-1927-0745ffa47a86"),
                            Description = "最高权限管理者",
                            IsActive = true,
                            IsDel = false,
                            Name = "管理者"
            ...
            modelBuilder.Entity("WeChat.Domain.UserAndRoleMap", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("3a016f34-a23b-1664-1927-0745ffa47a86"),
                            RoleId = new Guid("3a016f34-a23c-37fb-4e07-f845581274a4"),
                            CreateTime = new DateTime(2022, 1, 15, 17, 18, 18, 685, DateTimeKind.Local).AddTicks(283),
                            CreateUserId = new Guid("3a016f34-a23b-1664-1927-0745ffa47a86")
                        });
                });
            ...
            modelBuilder.Entity("WeChat.Domain.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a016f34-a23b-1664-1927-0745ffa47a86"),
                            CreateTime = new DateTime(2022, 1, 15, 17, 18, 18, 684, DateTimeKind.Local).AddTicks(4244),
                            IsActive = true,
                            IsDel = true,
                            LoginName = "admin",
                            NickName = "管理员",
