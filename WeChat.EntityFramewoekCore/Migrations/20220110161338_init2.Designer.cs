...
namespace WeChat.EntityFramewoekCore.Migrations
{
    ...
    [Migration("20220110161338_init2")]
    partial class init2
    {
            ...
            modelBuilder.Entity("WeChat.Domain.WeChat.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a6584a96-cccb-8640-c519-3a0156f111d4"),
                            CreateTime = new DateTime(2022, 1, 11, 0, 13, 37, 620, DateTimeKind.Local).AddTicks(8361),
                            CreateUserId = new Guid("df261f49-69a9-7187-3c94-3a0156f111d4"),
                            Description = "最高权限管理者",
                            IsActive = true,
                            IsDel = false,
                            Name = "管理者"
            ...
            modelBuilder.Entity("WeChat.Domain.WeChat.UserAndRoleMap", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("df261f49-69a9-7187-3c94-3a0156f111d4"),
                            RoleId = new Guid("a6584a96-cccb-8640-c519-3a0156f111d4"),
                            CreateTime = new DateTime(2022, 1, 11, 0, 13, 37, 620, DateTimeKind.Local).AddTicks(9443),
                            CreateUserId = new Guid("df261f49-69a9-7187-3c94-3a0156f111d4")
                        });
                });
            ...
            modelBuilder.Entity("WeChat.Domain.WeChat.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("df261f49-69a9-7187-3c94-3a0156f111d4"),
                            CreateTime = new DateTime(2022, 1, 11, 0, 13, 37, 620, DateTimeKind.Local).AddTicks(5905),
                            IsActive = true,
                            IsDel = true,
                            LoginName = "admin",
                            NickName = "管理员",
