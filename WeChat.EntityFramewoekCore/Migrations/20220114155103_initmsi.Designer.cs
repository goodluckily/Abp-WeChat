...
namespace WeChat.EntityFramewoekCore.Migrations
{
    ...
    [Migration("20220114155103_initmsi")]
            ...
            modelBuilder.Entity("WeChat.Domain.WeChat.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a016b75-d584-c148-3187-f2ef0229cc01"),
                            CreateTime = new DateTime(2022, 1, 14, 23, 51, 2, 788, DateTimeKind.Local).AddTicks(8303),
                            CreateUserId = new Guid("3a016b75-d584-da89-1bbf-c95980f1687e"),
                            Description = "最高权限管理者",
                            IsActive = true,
                            IsDel = false,
                            Name = "管理者"
            ...
            modelBuilder.Entity("WeChat.Domain.WeChat.UserAndRoleMap", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("3a016b75-d584-da89-1bbf-c95980f1687e"),
                            RoleId = new Guid("3a016b75-d584-c148-3187-f2ef0229cc01"),
                            CreateTime = new DateTime(2022, 1, 14, 23, 51, 2, 788, DateTimeKind.Local).AddTicks(9282),
                            CreateUserId = new Guid("3a016b75-d584-da89-1bbf-c95980f1687e")
                        });
                });
            ...
            modelBuilder.Entity("WeChat.Domain.WeChat.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a016b75-d584-da89-1bbf-c95980f1687e"),
                            CreateTime = new DateTime(2022, 1, 14, 23, 51, 2, 788, DateTimeKind.Local).AddTicks(5848),
                            IsActive = true,
                            IsDel = true,
                            LoginName = "admin",
                            NickName = "管理员",
