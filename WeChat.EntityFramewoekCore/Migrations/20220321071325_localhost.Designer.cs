...
namespace WeChat.EntityFramewoekCore.Migrations
{
    ...
    [Migration("20220321071325_localhost")]
            ...
            modelBuilder.Entity("WeChat.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a02bd7f-a674-2816-1cd0-323ae8b6e9f0"),
                            CreateTime = new DateTime(2022, 3, 21, 15, 13, 25, 109, DateTimeKind.Local).AddTicks(877),
                            CreateUserId = new Guid("3a02bd7f-a674-1ee1-8ef9-9de81384a371"),
                            Description = "最高权限管理者",
                            IsActive = true,
                            IsDel = false,
                            Name = "管理者"
            ...
            modelBuilder.Entity("WeChat.Domain.UserAndRoleMap", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("3a02bd7f-a674-1ee1-8ef9-9de81384a371"),
                            RoleId = new Guid("3a02bd7f-a674-2816-1cd0-323ae8b6e9f0"),
                            CreateTime = new DateTime(2022, 3, 21, 15, 13, 25, 109, DateTimeKind.Local).AddTicks(1996),
                            CreateUserId = new Guid("3a02bd7f-a674-1ee1-8ef9-9de81384a371")
                        });
                });
            ...
            modelBuilder.Entity("WeChat.Domain.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a02bd7f-a674-1ee1-8ef9-9de81384a371"),
                            CreateTime = new DateTime(2022, 3, 21, 15, 13, 25, 108, DateTimeKind.Local).AddTicks(8107),
                            IsActive = true,
                            IsDel = true,
                            LoginName = "admin",
                            NickName = "管理员",
