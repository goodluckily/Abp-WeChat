...
namespace WeChat.EntityFramewoekCore.Migrations
{
    ...
    [Migration("20220105081911_init1")]
    partial class init1
    {
            ...
            modelBuilder.Entity("WeChat.Domain.WeChat.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3b06ea55-9997-a7b4-effa-3a013b7ee4c6"),
                            Active = true,
                            CreateTime = new DateTime(2022, 1, 5, 16, 19, 10, 154, DateTimeKind.Local).AddTicks(3504),
                            CreateUserId = new Guid("8db61cfc-c0f7-fcc9-7b83-3a013b7ee4c5"),
                            Description = "最高权限管理者",
                            IsDel = false,
                            Name = "管理者"
                        });
            ...
            modelBuilder.Entity("WeChat.Domain.WeChat.UserAndRoleMap", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("8db61cfc-c0f7-fcc9-7b83-3a013b7ee4c5"),
                            RoleId = new Guid("3b06ea55-9997-a7b4-effa-3a013b7ee4c6"),
                            CreateTime = new DateTime(2022, 1, 5, 16, 19, 10, 154, DateTimeKind.Local).AddTicks(6244),
                            CreateUserId = new Guid("8db61cfc-c0f7-fcc9-7b83-3a013b7ee4c5")
                        });
                });
            ...
            modelBuilder.Entity("WeChat.Domain.WeChat.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8db61cfc-c0f7-fcc9-7b83-3a013b7ee4c5"),
                            CreateTime = new DateTime(2022, 1, 5, 16, 19, 10, 150, DateTimeKind.Local).AddTicks(6479),
                            IsActive = true,
                            IsDel = true,
                            LoginName = "admin",
                            NickName = "管理员",
