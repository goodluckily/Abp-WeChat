    ...
    public partial class init001 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("3a03022a-4eb8-4fab-7d8b-7a3d1a9a513e"), new DateTime(2022, 4, 3, 23, 13, 59, 992, DateTimeKind.Local).AddTicks(9640), new Guid("3a03022a-4eb8-fef4-33c0-be5f1f8ec581"), "最高权限管理者", null, null, true, false, "管理者" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("3a03022a-4eb8-fef4-33c0-be5f1f8ec581"), null, new DateTime(2022, 4, 3, 23, 13, 59, 992, DateTimeKind.Local).AddTicks(7368), null, null, null, null, true, true, "admin", "管理员", "123456", null });

            migrationBuilder.InsertData(
                table: "UserAndRoleMap",
                columns: new[] { "RoleId", "UserId", "CreateTime", "CreateUserId" },
                values: new object[] { new Guid("3a03022a-4eb8-4fab-7d8b-7a3d1a9a513e"), new Guid("3a03022a-4eb8-fef4-33c0-be5f1f8ec581"), new DateTime(2022, 4, 3, 23, 13, 59, 993, DateTimeKind.Local).AddTicks(629), new Guid("3a03022a-4eb8-fef4-33c0-be5f1f8ec581") });
